...
class ViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        exampleBurger.addIngredient("Bun", newquantity: 2, newmeasurement: "Slices")
        exampleBurger.addIngredient("Ground Beef Patty", newquantity: 1, newmeasurement: "Pounds")
        exampleBurger.addIngredient("American Cheese Slice", newquantity: 1, newmeasurement: "Slices")
        ...
        exampleGrilledCheese.addIngredient("Bread", newquantity: 2, newmeasurement: "Slices")
        exampleGrilledCheese.addIngredient("American Cheese Slice", newquantity: 2, newmeasurement: "Slices")
        exampleGrilledCheese.addIngredient("Unsalted Butter", newquantity: 2, newmeasurement: "TableSpoons")
